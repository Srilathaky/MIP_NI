...
public class MIP_BasePage {
	...
	public WebElement waitForElementToPresent(By by) {
		WebDriverWait w = new WebDriverWait(driver, MIP_Constants.TIMEOUTINSECONDS);
	...
	public void clickOnSearchButton() {
		try {
			...
			this.waitForElementTobeClickable(By.id("search-icon"));
	...
	public void clickonLogout() {
		this.waitForElementToPresent(By.linkText("Logout")).click();
	...
	public void confirmPopUp(String option) {
		this.waitForElementToPresent(By.id("popup_message"));
