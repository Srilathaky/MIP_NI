...
public class MIP_BranchManagement_TestData {
	...
	public String[][] addBranchDetails() {
		String[][] data = { { "BC4", "Edificio Ofiplaza, Torre 5, Piso 3, #531", "Managua", "Nicau",
	...
	public String[][] listBranchDetails() {
		String[][] data = { { "BC05", "BIMA", "streetone", "branchone", "listtest" } };
		return data;
	}
	...
	public String[][] deactivateBranch() {
		...
		String[][] data = { { branchName, "Branch Name : The selected Branch cannot be de-activated. " + count
				+ " user(s) are associated with this branch." } };
		return data;
	}
