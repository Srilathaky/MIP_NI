...
public class MIP_AddBranchPage extends MIP_BasePage {
	...
	public boolean validateAddBranchObjecs() {
		...
		boolean value1 = this.waitForElementToPresent(By.id("label_branchName")).getText().trim()
				.equalsIgnoreCase("Branch Name : *");
		boolean value2 = this.waitForElementToPresent(By.id("branchName")).getAttribute("type")
				.equalsIgnoreCase("text");

		boolean value3 = driver.findElement(By.id("label_branchStreet")).getText().trim()
				.equalsIgnoreCase("Street : *");
		boolean value4 = driver.findElement(By.id("branchStreet")).getAttribute("type").equalsIgnoreCase("text");

		boolean value5 = driver.findElement(By.id("label_branchRegion")).getText().trim()
				.equalsIgnoreCase("Region : *");
		boolean value6 = this.waitForElementToPresent(By.id("branchRegion")).getAttribute("type")
				.equalsIgnoreCase("text");

		boolean value7 = this.waitForElementToPresent(By.id("label_branchCity")).getText().trim()
				.equalsIgnoreCase("City : *");
		boolean value8 = this.waitForElementToPresent(By.id("branchCity")).getAttribute("type")
				.equalsIgnoreCase("text");

		boolean value9 = this.waitForElementToPresent(By.id("saveBtn")).getText().trim().equalsIgnoreCase("Save");
		boolean value10 = this.waitForElementToPresent(By.id("clearBtn")).getText().trim().equalsIgnoreCase("Clear");
	...
	public String getValidationMsg() {
		...
		this.waitForElementToVisible(By.xpath("//div[@id='validationMessages']//li"));
	 ...
	 * @return
	 */
	public MIP_AddBranchPage enterBranchInfo(String name, String street, String region, String city) {
		logger.info("Entering branch Information in Add Branch page");
		this.enterText(this.waitForElementToPresent(By.id("branchName")), name);
		this.enterText(this.waitForElementToPresent(By.id("branchStreet")), street);
		this.enterText(this.waitForElementToPresent(By.id("branchRegion")), region);
		this.enterText(this.waitForElementToPresent(By.id("branchCity")), city);
	...
	public String getBranchInfo(String value) {
		...
		if (value.equalsIgnoreCase("name")) {
			...
			return this.waitForElementToPresent(By.id("branchStreet")).getText();
		} else if (value.equalsIgnoreCase("region")) {
			return this.waitForElementToPresent(By.id("branchRegion")).getText();
	...
	public String getmessage() {
		...
		return this.waitForElementToPresent(By.className("error-div-body")).getText();
	}
}
