...
public class MIP_ChangePasswordPage extends MIP_BasePage {
	...
	public boolean validateChangePassObjects() {
		...
		if (this.waitForElementToVisible(By.id("currentHash")).isDisplayed()
				...
				&& this.waitForElementToVisible(By.id("confirmHash")).isDisplayed()
				&& this.waitForElementToVisible(By.id("saveBtn")).isDisplayed()
				&& this.waitForElementToVisible(By.id("clearBtn")).isDisplayed()) {
			return true;
		}
		return false;
	}
	...
	public MIP_ChangePasswordPage enterPassworddata(String oldpass, String newpass, String confpass) {
	...
	public String getOldPassword() {
		return this.waitForElementToVisible(By.id("currentHash")).getAttribute("value");
	}

	public String getNewPassword() {
		return this.waitForElementToVisible(By.id("newHash")).getAttribute("value");
	}

	public String getConfPassword() {
		return this.waitForElementToVisible(By.id("confirmHash")).getAttribute("value");
	}

	public String getValidationMsg() {
		logger.info("Getting Validation message in Change Password page");
		return this.waitForElementToVisible(By.xpath("//div[@id='validationMessages']/li")).getText();
	}
